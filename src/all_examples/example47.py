...
from src.all_examples.example46 import partition, merge_dictionaries, map_frequencies
...
async def main(partition_size: int):
    with open(
            r'C:\Users\fkhor\PycharmProjects\asynchronous_and_competitiveness\data\googlebooks-a.txt',
            encoding='utf-8') as f:
        ...
        with concurrent.futures.ProcessPoolExecutor() as pool:
            ...
            print(f"anteriori встречается {final_result['anteriori']} раз.")
...
if __name__ == "__main__":
    asyncio.run(main(partition_size=5000))
